...
OBS_OBS_ATTRS = ['action_result', 'alerts', 'available_actions', 'away_race_requested', 'build_queue', 'cargo', 'cargo_slots_available', 'clear', 'control_groups', 'copy', 'feature_effects', 'feature_minimap', 'feature_screen', 'feature_units', 'fromkeys', 'game_loop', 'get', 'home_race_requested', 'items', 'keys', 'last_actions', 'map_name', 'multi_select', 'player', 'pop', 'popitem', 'production_queue', 'radar', 'score_by_category', 'score_by_vital', 'score_cumulative', 'setdefault', 'single_select', 'update', 'upgrades', 'values']
